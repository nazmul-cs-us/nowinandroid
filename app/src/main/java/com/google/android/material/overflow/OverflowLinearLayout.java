...
public class OverflowLinearLayout extends LinearLayout {
  ...
  @NonNull private final AppCompatImageButton overflowButton;
  ...
  public OverflowLinearLayout(
    ...
    TooltipCompat.setTooltipText(
        overflowButton,
        getResources().getString(R.string.m3_overflow_linear_layout_button_tooltip_text));
  ...
  public void setOverflowButtonIcon(@Nullable Drawable icon) {
    if (icon != null) {
      overflowButton.setImageDrawable(icon);
    } else {
      overflowButton.setImageResource(R.drawable.ic_overflow_more_24dp);
    }
  }
  ...
  public void setOverflowButtonIconResource(@DrawableRes int iconResourceId) {
    overflowButton.setImageResource(iconResourceId);
  }
  ...
  public Drawable getOverflowButtonIcon() {
    return overflowButton.getDrawable();
  }
  ...
  private void handleOverflowButtonClick(PopupMenu popupMenu, int overflowItemIconPadding) {
    ...
    for (View view : overflowViews) {
      ...
      CharSequence text = getMenuItemText(view, lp.overflowText);
  ...
  @Nullable
  private static CharSequence getMenuItemText(@NonNull View view, @Nullable CharSequence text) {
