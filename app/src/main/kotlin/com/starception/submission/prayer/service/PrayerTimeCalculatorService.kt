...
class PrayerTimeCalculatorService @Inject constructor(
    ...
    fun calculatePrayerTimes(
        ...
        logPrayerTimeResult(
            "ISHA",
            ishaTime,
            settings.timeOffsets.isha,
            if (settings.getEffectiveIshaAngle() != null) {
                "${settings.getEffectiveIshaAngle()}° depression angle"
            } else {
                "${settings.getEffectiveIshaDelay()} minutes after sunset"
            },
        )
