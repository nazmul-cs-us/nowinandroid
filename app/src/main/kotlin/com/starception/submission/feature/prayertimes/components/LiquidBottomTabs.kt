...
import com.starception.submission.feature.prayertimes.components.utils.DampedDragAnimation
import com.starception.submission.feature.prayertimes.components.utils.InteractiveHighlight
            ...
            Box(
                Modifier
                    ...
                    .graphicsLayer {
                        translationX =
                            if (isLtr) {
                                dampedDragAnimation.value * tabWidth + pillCenterOffset + panelOffset
                            } else {
                                size.width - (dampedDragAnimation.value + 1f) * tabWidth - pillCenterOffset + panelOffset
                            }
                    }
