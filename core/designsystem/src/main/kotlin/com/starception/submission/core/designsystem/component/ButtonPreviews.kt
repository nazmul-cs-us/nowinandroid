...
// The buttons themselves moved to :core:components so the shared settings UI can
// use them. These previews stayed behind because they render inside NiaTheme,
// which applies dynamic colour and is Android-only — and a preview that does not
// use the real theme is not showing the real component.
